...
#   ./revert-vm.sh ebpf-target                 # revert to "lab-ready"
#   ./revert-vm.sh ebpf-target clean-updated   # revert to a named snapshot
#
# Use this to undo destructive/offensive examples (37–42), or to get back to a
# clean tooled baseline. Reverting to a running-state snapshot restores it running.
set -euo pipefail
