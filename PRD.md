...
| Addenda *(optional)* | 68–69 | capstone addendum: observing a homomorphic-encryption (TFHE-rs) workload, data-blind; appendix: eBPF metrics with Performance Co-Pilot (pmdabpf/pmdabpftrace, grafana-pcp) |
