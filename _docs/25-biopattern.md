...
Highest-risk: the `block_rq_issue` field offsets (verify vs. the format
file — they've changed across kernels), `dev_t` decoding, and the
observable-gauge API in opentelemetry 0.27. The first build and run are
the test.*
